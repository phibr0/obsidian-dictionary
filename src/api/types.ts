...
export class Convert {
    public static toDictionaryWord(json: string): DictionaryWord[] {
        return cast(JSON.parse(json), a(r("DictionaryWord")));
    }

    public static dictionaryWordToJson(value: DictionaryWord[]): string {
        return JSON.stringify(uncast(value, a(r("DictionaryWord"))), null, 2);
    }
}
...
const typeMap: any = {
    "DictionaryWord": o([
        ...
        { json: "phonetics", js: "phonetics", typ: a(r("Phonetic")) },
        { json: "meanings", js: "meanings", typ: a(r("Meaning")) },
    ], false),
    "Meaning": o([
